...
export type HeadToHeadQuery = { __typename?: 'Query', headToHead: { __typename?: 'Series', wins: number, losses: number, ties: number } };
...
export type PlayerModalQuery = { __typename?: 'Query', player: { __typename?: 'Player', gamesPlayed: number, streak: number, maxStreak: number, lastPlay?: string | null, averageTime?: string | null, bestScore?: { __typename?: 'Score', date: string, time: string, seconds: number } | null, worstScore?: { __typename?: 'Score', date: string, time: string, seconds: number } | null } };
